...
?>
   ...
   <!-- _______________________________________________________________________________________________________________________________________________________ -->
        ...
        <h1><a name="bilantop"></a>BILAN 2007/2008</h1>
        <br/>
        <table align="center">
            <tr width="64">
   ...
   <!-- _____________________________________________________________ATHLETISME_________________________________________________________________ -->
        ...
        <ul class="nivun">
            <li><u>16 titres de Champions départementaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Estelle BARICAULT&nbsp;:</b> 1500m junior</li>
                    <li><b>Killian REY&nbsp;:</b> poids benjamin</li>
                    <li><b>Cédric MICHEL&nbsp;:</b> 50m minime</li>
                    <li><b>Valentin SCHUHLER :</b> 100m minime</li>
                    <li><b>Lucas WINGERTER :</b> poids minime</li>
                    <li><b>Tom CALVI :</b> 3000m cadet</li>
                    <li><b>Jonathan MATERN :</b> 3000m junior</li>
                    <li><b>Guillaume HAMM&nbsp;:</b> longueur junior &#8211; poids junior</li>
                    <li><b>Relais 4x60</b> minimes filles &#8211; <b>Relais 4x60</b> minimes garçons</li>
                </ul>
            </li>
            <br/>
            <li><u>17 titres de Vice-Champions départementaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Emilie PIGEOT&nbsp;:</b> 100m minime</li>
                    <li><b>Stacy RHIM :</b> 50m haies minime</li>
                    <li><b>Cynthia LUHMANN&nbsp;: </b>poids minime</li>
                    <li><b>Alexiane DOUMBA&nbsp;:</b> 100m cadette</li>
                    <li><b>Laura DURAND&nbsp;: </b>1500m junior, longueur junior</li>
                    <li><b>Killian REY&nbsp;:</b> 50m benjamin, 100m Benjamin, longueur benjamin</li>
                    <li><b>Bertil URBAN :</b> 1000m benjamin</li>
                    <li><b>Valentin SCHUHLER :</b> 50m minime</li>
                    <li><b>Hugo WEINMANN : </b>poids minime</li>
                    <li><b>Jonathan MATERN&nbsp;:</b> poids junior</li>
                    <li><b>Relais 4x60m benjamins garçons</b></li>
                </ul>
            </li>
            <br/>
        ...
        <ul class="nivun">
            <li><u>10 titres de Champions Régionaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Valentin SCHUHLER&nbsp;:</b> 50m minime, 100m minime</li>
                    <li><b>Jonathan MATERN&nbsp;: </b>3000m junior</li>
                    <li><b>Relais 4x60 benjamines - 4x60 minimes filles &#8211; 4x60 benjamin - 4x100m cadettes</b></li>
                </ul>
            </li>
            <br/>
            <li><u>13 titres de Vice Champions Régionaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Killian REY&nbsp;:</b> 50m benjamin</li>
                    <li><b>Guillaume GIRARD REYDET :</b> 1000m benjamin</li>
                    <li><b>Adrien PAULY :</b> hauteur Benjamin</li>
                    <li><b>Cédric MICHEL&nbsp;:</b> 50m minime, 100m minime</li>
                    <li><b>Sascha NADIG&nbsp;:</b> javelot minime</li>
                    <li><b>Anthony GERLEI :</b>triple saut cadet</li>
                    <li><b>Guillaume HAMM&nbsp;: </b>poids junior, longueur junior</li>
                </ul>
            </li>
            <br/>
            <li><u>8 médailles de bronze</u>
            </li>
        </ul>
        <br/>
        ...
        <br/>
        <p class="elevegagnant"><b>Lorette FERRERAS&nbsp;: </b>50m, ½ finaliste sur 50m</p>
        <p class="elevegagnant"><b>Cédric MICHEL&nbsp;: </b>50m, 100m, ½ finaliste sur 50m</p>
        <br/>
        <p class="elevegagnant"><b>Priscillia FABRE&nbsp;:</b> 50m</p>
        <p class="elevegagnant"><b>Ophélie LATASSE&nbsp;: </b>50m</p>
        <p class="elevegagnant"><b>Lucas DAMANT&nbsp;: </b>50m</p>
   ...
   <!-- _____________________________________________________________BADMINTON__________________________________________________________________ -->
        ...
        <ul class="nivun">
            ...
            <li>Vice Champions Départementaux :
                <ul class="nivdeux">
                    ...
                    <li><b>Régory HEIDERICH&nbsp;:</b> minime</li>
                </ul>
            </li>
        ...
        <br/>
        <h3>Championnat Régional – 2 avril 2008 – Pont à Mousson</h3>
        <p>&nbsp;18 élèves (14 collégiens &#8211; 4 lycéens)</p>
        <br/>
   ...
   <!-- _____________________________________________________________CROSS______________________________________________________________________ -->
        ...
        <p class="elevegagnant"><b>Cynthia LUHMANN</b> vice Championne de Moselle Minime 2</p>
        <br/>
        ...
        <br/>
        <h3>Championnat Régional -12 décembre 2007 &#8211; Nancy</h3>
        <p>&nbsp;33 élèves participent (27 collégiens-6 lycéens)</p>
        <br/>
   ...
   <!-- _____________________________________________________________NATATION___________________________________________________________________ -->
        ...
        <h3>Championnat Régional de Natation individuel &#8211; 6 février 2008 &#8211; Nancy</h3>
        <p>&nbsp;10 élèves (1 collégien &#8211; 9 lycéens)</p>
        <br/>
        <p class="elevegagnant"><b>Simon AMBROGI&nbsp;: </b>
            <ul class="recompense">
                <li>Champion régional 50m papillon minime</li>
            </ul>
        </p>
        <p class="elevegagnant"><b>Amandine FOUCHET&nbsp;:</b> 
            <ul class="recompense">
                <li>vice championne régionale 100m dos junior</li>
                <li>3<sup>ème</sup> 50m nage libre open</li>
            </ul>
        </p>
        <p class="elevegagnant"><b>Guillaume HAMM&nbsp;:</b>
            <ul class="recompense">
                <li>vice champion régional 100m nage libre junior</li>
                <li>Vice champion régional 50m open</li>
            </ul>
        </p>
        <p class="elevegagnant"><b>Relais 4x50m nage libre lycée&nbsp;:</b>
            <ul class="recompequ">
                <li><b>Equipe 1&nbsp;:</b> championne régionale</li>
        ...
        <ul class="nivun">
            <li><u>21 titres de Champions Départementaux&nbsp;:</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Amandine FOUCHET :</b> 50m dos junior</li>
                    <li><b>Barbara KEHRER : </b>50m brasse cadette</li>
                    <li><b>Nicolas LEFEVRE&nbsp;:</b> 25m papillon benjamin, 50m nage libre benjamin</li>
                    <li><b>Killian REY&nbsp;: </b>50m dos benjamin</li>
                    <li><b>Alexandre CHERY&nbsp;:</b> 50m brasse benjamin</li>
                    <li><b>Guillaume HAMM&nbsp;: </b>25m papillon juniors, 50m dos juniors, 50m nage libre junior</li>
                    <li>Relais 4 nages 4x25m benjamines&nbsp;: 
                        <b>Cécile GIGON &#8211; Ophélie LATASSE &#8211; Adeline COULEMON &#8211; Lara BAUDINET</b></li>
                    <li>Relais 4 nages 4x25m minimes filles&nbsp;: 
                        <b>Mélanie BATIFOULIER &#8211; Lorette FERRERAS &#8211; Stacy RHIM&#8211; Jessica MULLER</b></li>
                    <li>Relais nage libre 4x25m lycée&nbsp;: 
                        <b>Anaïs GUIONNEAUD, Amandine FOUCHET, Marine SPECHT, Estelle BARICAULT</b></li>
                    <li>Relais 4 nages 4x25m lycée&nbsp;:
                        <b> Anaïs GUIONNEAUD, Amandine FOUCHET, Barbara KEHRER, Marine SPECHT</b></li>
                    <li>Relais nage libre 4x25m benjamins&nbsp;: 
                        <b>Nicolas LEFEVRE, Killian REY, Olivier BAUDINET, Guillaume GIRARD-REYDET</b></li>
                    <li>Relais 4 nages 4x25m benjamins&nbsp;: 
                        <b>Nicolas LEFEVRE, Killian REY, Alexandre CHERY, Yannick MUNIER</b></li>
                    <li>Relais nage libre 4x25m minimes&nbsp;: 
                        <b>Simon AMBROGI, Tristan BRUNEL, Lucas WINGERTER, Aphisit JUVILLE</b></li>
                    <li>Relais 4 nages 4x25m minimes&nbsp;: 
                        <b>Simon AMBROGI, Tristan BRUNEL, Loic VANDERPOORTE, Aphisit JUVILLE</b></li>
                </ul>
            </li>
            <br/>
            <li><u>11 titres de vice champions départementaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Yannick MUNIER&nbsp;: </b>50m dos benjamin</li>
                    <li><b>Killian REY&nbsp;:</b> 50m nage libre benjamin</li>
                    <li><b>Simon AMBROGI&nbsp;:</b> 25m papillon minime, 50m nage libre minime</li>
                    <li><b>Aphisit JUVILLE&nbsp;: </b>50m brasse minime</li>
                    <li><b>Nicolas LEBRUN&nbsp;:</b> 50m nage libre junior</li>
                    <li><b>Relais nage libre 4x25m minimes filles&nbsp;</b></li>
                </ul>
            </li>
        </ul>
        <br/>
        ...
        <ul class="nivun">
            <li><u>12 titres de Champions Régionaux&nbsp;:</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Nicolas LEFEVRE :</b> 25m papillon Benjamin</li>
                    <li><b>Killian REY : </b>50m dos Benjamin, 50m nage libre benjamin</li>
                    <li><b>Alexandre CHERY&nbsp;:</b> 50m brasse benjamin</li>
                    <li>Relais 4 nages 4x25m benjamine : 
                        <b>Ophélie LATASSE, Cécile GIGON, Adeline COULEMON, Lara BAUDINET</b></li>
                    <li>Relais 4 nages 4x25m lycée&nbsp;:
                        <b>Anaïs GUIONNEAUD, Amandine FOUCHER, Solène WOLFF, Marine SPECHT</b></li>
                    <li>Relais 4 nages 4x25m benjamin&nbsp;:
                        <b>Killian REY, Nicolas LEFEVRE, Alexandre CHERY, Lucas DAMANT</b></li>
                    <li>Relais nage libre 4x25m benjamin&nbsp;
                        <b>Killian REY, Nicolas LEFEVRE, Guillaume GIRARD REYDET, Lucas DAMANT</b></li>
                </ul>
            </li>
            <br/>
            <li><u>16 Titres de vice champion Régionaux</u>
                <ul class="nivdeux">
                    ...
                    <li><b>Mélanie BATIFOULIER&nbsp;:</b> 50m nage libre minime</li>
                    <li><b>Amandine FOUCHER&nbsp;:</b> 50m nage libre junior</li>
                    <li><b>Lucas DAMANT&nbsp;: </b>50m nage libre benjamin</li>
                    <li><b>Simon AMBROGI&nbsp;:</b> 25m papillon minime, 50m nage libre minime</li>
                    <li><b>Guillaume HAMM&nbsp;:</b> 25m papillon junior, 50m nage libre junior</li>
                    <li>Relais 4 nages 4x25m minime fille&nbsp;: 
                        <b>Stacy RHIM, Jessica MULLER, Mélanie BATIFOULIER, Lorette FERRERAS</b></li>
                    <li>Relais nage libre 4x25m minime fille&nbsp;: 
                        <b>Stacy RHIM, Jessica MULLER, Mélanie BATIFOULIER, Estibaliz DOMINGUEZ</b></li>
                    <li>Relais nage libre 4x25m lycée&nbsp;: 
                        <b>Anaïs GUIONNEAUD, Amandine FOUCHER, Solène WOLFF, Marine SPECHT</b></li>
                    <li>Relais nage libre 4x25m minime garçon&nbsp;: 
                        <b>Simon AMBROGI, Tristan BRUNEL, Lucas WINGERTER, Aphisit JUVILLE</b></li>
                    <li>Relais 4 nages 4x25m minime garçon&nbsp;: 
                        <b>Simon AMBROGI, Jonathan NONNENMACHER, Lucas WINGERTER, Aphisit JUVILLE</b></li>
                </ul>
            </li>
            <br/><br/>
            <li>Sont qualifiés pour le championnat national&nbsp;:
                <ul class="nivdeux">
                    ...
                    <li>Le relais 4 nages minime garçon</li>
                </ul>
            </li>
        </ul>
        <br/>
        ...
        <p>Ont participé&nbsp;:
            <ul class="recompense">
                <li><b>Mélanie BATIFOULIER, Ophélie LATASSE, Alexandre CHERY,</b></li>
                <li>Le relais lycée&nbsp;:<b> Amandine FOUCHER, Solène WOLF, Hélène CHANTERELLE, Anaïs GUIONNEAUD</b></li>
                <li>Le relais minime garçon&nbsp;: <b>Loïc VANDERPOORTE, Aphisit JUVILLE, Lucas WINGERTER, Jonathan NONNENMACHER</b></li>
                <li>Le relais 4 nages benjamin garçon&nbsp;: <b>Killian REY, Alexandre CHERY, Nicolas LEFEVRE, Lucas DAMANT</b></li>
            </ul>
        </p>
        <p class="retour">
            <a href="#bilantop">retour</a>
   ...
   <!-- _____________________________________________________________TENNIS DE TABLE____________________________________________________________ -->
        ...
        <p class="elevegagnant"><b>Alexandre NICOLAS :</b> Champion départemental junior</p>
        <br/>
        <p class="elevegagnant"><b>Lorette FERRARAS :</b> 3<sup>ème</sup> minime fille</p>
        <br/>
        <h3>Championnat Régional &#8211; 2 avril 2008 &#8211; Pont à Mousson</h3>
        <p>&nbsp;9 élèves (7 collégiens &#8211; 2 lycéens)</p>
        <br/>
        <p class="elevegagnant"><b>Mélodie HEITZ :</b> Championne régionale junior</p>
        <p class="retour">
            <a href="#bilantop">retour</a>
        </p>
        <br/>
