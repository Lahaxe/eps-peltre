...
?>
   ...
   <!-- _______________________________________________________________________________________________________________________________________________________ -->
        ...
        <h1><a name="bilantop"></a>BILAN 2009/2010</h1>
        <br/>
        <table align="center">
            <tr width="64">
   ...
   <!-- _____________________________________________________________BADMINTON__________________________________________________________________ -->
        ...
        <ul class="nivun">
            ...
            <li>Élèves classés 3ème:
                <ul class="nivdeux">
                    ...
                    <li><b>Lorette FERRERAS :</b> (cadette)</li>
                    <li><b>Marion KAUFFMANN :</b> (junior)</li>
                    <li><b>Sophian KORCHI :</b> (junior)</li>
                </ul>
            </li>
        </ul>
        <ul class="nivun">
        ...
        <p>&nbsp;25 élèves (16 collégiens - 9 lycéens)</p>
        <br/>
   ...
   <!-- _____________________________________________________________CROSS______________________________________________________________________ -->
        ...
        <p class="elevegagnant"><b>Nicolas LEBRUN</b> Champion de Moselle Junior</p>
        <br/>
        <p class="elevegagnant"><b>Jessy TAVARES</b> vice champion de Moselle Minime 1</p>
        <p class="elevegagnant"><b>Valentin BOILEAU</b> vice champion de Moselle Minime 2</p>
        <p class="elevegagnant"><b>Morgane ISSEN</b> vice championne de Moselle Cadette</p>
        <p class="elevegagnant"><b>Alexandre FAROLDI</b> vice champion de Moselle Junior</p>
        <br/>
        <p class="elevegagnant"><b>Lara BAUDINET</b> médaillée de bronze Minime 1</p>
        <p class="elevegagnant"><b>Adeline COULEMON</b> médaillée de bronze Minime 2</p>
        <p class="elevegagnant"><b>Mélissa ZUPANCIC</b> médaillée de bronze Cadette</p>
        ...
        <br/>
        <h3>Championnat Régional - 9 décembre 2009 &#8211; Nancy</h3>
        <p>&nbsp;38 élèves participent (23 collégiens-15 lycéens)</p>
        <br/>					
        ...
        <ul class="nivun">
            ...
            <li><b>Adeline COULEMON, Julie PIGEOT, Muriel PAQUIN, Marine SACCO, Sarah MUZALIA</b></li>
        ...
        <p align=center>
            ...
            <img src="./photosbilan/0910/crossnat4.jpg">
        </p>
        <p class="retour">
            <a href="#bilantop">retour</a>
        </p>
   ...
   <!-- _____________________________________________________________NATATION___________________________________________________________________ -->
        ...
        <ul class="nivun">
            ...
            <br/>
            <li><u>9 médailles de bronze</u></li>					
        </ul>
        <br/>					
   ...
   <!-- _____________________________________________________________TENNIS_____________________________________________________________________ -->
        ...
        <h3>Championnat départemental &#8211; 19 mai 2010 &#8211; Châtel Saint Germain</h3>
        <p>&nbsp;5 lycéens</p>
        <br/>
        <p class="elevegagnant"><b>Allan VIGNEULLE : Champion départemental cadet</b></p>
        <p class="elevegagnant"><b>Alisson GOUILLAUD : Championne départementale junior</b></p>
        <br/>
        <p class="elevegagnant"><b>Sébastien LAMBALOT : Vice Champion départemental cadet</b></p>
        <p class="elevegagnant"><b>Angélique GADROIS : Vice Championne départementale junior</b></p>
        <p class="retour">
            <a href="#bilantop">retour</a>
        </p>
        <br/>
   <!-- _____________________________________________________________TENNIS DE TABLE____________________________________________________________ -->
        ...
        <h3>Championnat Départemental &#8211; 3 mars 2010 - Thionville</h3>
        <p>&nbsp;11 élèves (9 collégiens - 2 lycéens)</p>
        <br/>
        <p class="elevegagnant"><b>Lorette FERRERAS :</b> Championne départementale cadette</p>
        <br/>
        <p class="elevegagnant"><b>Sébastien LAMBALOT :</b> Vice Champion départemental cadet</p>
        <br/>
        <p class="elevegagnant"><b>Corentin LAURENT :</b> 3<sup>ème</sup> minime</p>
        <br/>
        <h3>Championnat Régional &#8211; 7 avril 2010 &#8211; Pont à Mousson</h3>
